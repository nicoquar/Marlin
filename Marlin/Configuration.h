...
#define STRING_CONFIG_H_AUTHOR "(NIK 1.0, Ender-3 Pro)" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // Creality Ender-3 Pro
  #define DEFAULT_bedKp 14.4
  #define DEFAULT_bedKi 2.60
  #define DEFAULT_bedKd 53.1
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 141.6 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET {-44,-13, -1.35 }
